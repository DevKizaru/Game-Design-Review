...
- **Gargalo em série / cadeia obrigatória** — o oposto topológico da redundância, e a armadilha que melhor sobrevive ao review, porque *parece* profundidade: cada elo tem nome, arte e tela próprios, então a proposta se lê como conteúdo. Em paralelo o dano é uma fonte matar as outras; em série é o sistema de apoio virar gargalo do sistema principal. A vazão é a do elo mais fraco — todo tuning fora do gargalo rende zero — e a confiabilidade **cai** a cada elo: três elos com 15% de ociosidade dão 39% de chance de o jogador chegar e a linha estar parada, contra 15% de uma fonte só. Passe elo por elo com o teste **“decisão ou só um passo?”**: se o elo não tem escolha que mude resultado, nem risco próprio, nem saída que sirva a outra coisa além do próximo elo, é **pedágio**. Cadeia de N elos com N−1 pedágios é uma fonte única com N−1 telas de espera — colapse os pedágios em custo e o jogador não perde decisão nenhuma, porque não havia nenhuma. Seção 11 de `references/modelagem.md`; a conta em `auditoria_calc.py cadeia`.
